...
public class ChangeClassInterface extends JFrame {
	...
	public ChangeClassInterface() {
		...
		btnPublish.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Course course=new Course(coursename,teachernumber,majornumber,Float.parseFloat(coursecredit),schedule,coursenumber);
				Connection con=null;
				DBHelper dbhelper = new DBHelper();
				try {
					con = dbhelper.getCon();
					int n=CourseDao.courseModify(con, course);
					if(n==1){
